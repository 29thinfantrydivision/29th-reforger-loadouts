...
modded class SCR_GameModeEditor
{
	...
	//------------------------------------------------------------------------------------------------
	//! Offer the server this side's default kit as this client last wore it. Fires on every side
	//! change, not only the first, so switching sides seeds that side's kit rather than landing on
	//! bare defaults. The SIDE DEFAULT and not the last kit worn: a session starts where the roster
	//! says it starts, and only the personalisation of that kit is remembered.
