...
{
	[Attribute(desc: "What to look at: \"group/entry\", weapon-qualified as \"m16a3:optics/4x20\" where the group belongs to a gun. Naming a group without an entry counts everything in it; naming a group merged into a wider one through m_aIncludeGroups counts only what that group contributed", category: "29th")]
	string m_sWhen;
