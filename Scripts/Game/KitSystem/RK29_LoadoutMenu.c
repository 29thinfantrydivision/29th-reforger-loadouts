...
class RK29_LoadoutMenu
{
	...
	//------------------------------------------------------------------------------------------------
	//! Three tiers, most recent first: this session's unapplied edits, then what the class was last
	//! APPLIED as in any session, then the authored defaults. The middle tier is why a player who
	//! built a kit once does not rebuild it on a fresh server.
	void LoadPicks()
	{
