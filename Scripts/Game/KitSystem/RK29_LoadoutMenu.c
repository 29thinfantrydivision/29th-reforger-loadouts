...
class RK29_LoadoutMenu
{
	...
	//------------------------------------------------------------------------------------------------
	//! Re-checked while open: a changed body, or dead with no deploy menu, closes the menu. The round
	//! phase never does - a live re-kit is legal at any point, and a dead pick stashes for the next
	//! body.
